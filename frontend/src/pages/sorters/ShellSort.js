...
function ShellSort() {
    return (
        <>
            ...
            order of the array is not preserved. It is as well sensitive to input, 
            meaning the array values will affect the runtime/work the algorithm does. 
            Although its performance depends on the number of increments of h, and the 
            size of the common divisor the best-case runtime is O(NlogN), and the 
            worst-case along with the average-case runtime is O(N^(3/2)).
            </p>
        </>
    );
}
